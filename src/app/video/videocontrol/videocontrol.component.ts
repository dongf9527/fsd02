...
@Component({
  ...
  templateUrl: './videocontrol.component.html',
  styleUrls: ['./videocontrol.component.css']
})
export class VideoControlComponent implements OnInit {
  ...
  updateProgressBar() {
    ...
    const percentage = Math.floor((100 / this.videoView.videoPlayer.nativeElement.duration) * this.videoView.videoPlayer.nativeElement.currentTime);
